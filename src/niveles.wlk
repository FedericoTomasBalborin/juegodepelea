...
object colisiones
{
	method validar()
	{
		...
		game.onTick(4000,"colocarPocion",{=> visualesGeneral.agregarPocion()})
		game.onCollideDo(jugador2.personaje(),{pocionEnergia => pocionEnergia.removerPng(pocionEnergia)})
		game.onCollideDo(jugador1.personaje(),{pocionEnergia => pocionEnergia.removerPng(pocionEnergia)})		
